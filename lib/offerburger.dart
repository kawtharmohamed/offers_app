...
class Offerburger extends StatefulWidget {
  @override
  State<Offerburger> createState() => _OfferburgerState();
}
...
class _OfferburgerState extends State<Offerburger> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Burger offers"),
        titleSpacing: 00.0,
        centerTitle: true,
        toolbarHeight: 60.2,
        toolbarOpacity: 0.8,
                  ...
                  child: Container(
                    ...
                    child: FutureBuilder(
                        future: FirebaseFirestore.instance
                            .collection("offers")
                            .where('name', isEqualTo: "burger compo medium")
                            .get(),
              ...
              ? Padding(
                  ...
                  child: Container(
                    ...
                    child: FutureBuilder(
                        future: FirebaseFirestore.instance
                            .collection("offers")
                            .where('name', isEqualTo: "burger compo")
                            .get(),
                        builder: (context, AsyncSnapshot SnapShot) {
                          if (SnapShot.hasData == false)
                            return Text("no data");
